...
public class ServerCustomBotAction extends ServerBotAction<ServerCustomBotAction> {
    private final CustomBotAction realAction;

    public ServerCustomBotAction(String name, @NotNull CustomBotAction realAction) {
